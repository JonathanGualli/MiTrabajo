...
class EditActivityScreen extends StatefulWidget {
  ...
  @override
  State<EditActivityScreen> createState() => _AddActivityScreenState();
}

class _AddActivityScreenState extends State<EditActivityScreen> {
  ...
  void initState() {
    super.initState();
    activityController.text = widget.activityData.activityType;
    detailsController.text = widget.activityData.details;
    quantityController.text = widget.activityData.quantity.toString();
    priceController.text = widget.activityData.price.toStringAsFixed(2);
    date = widget.activityData.date;
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Align(
        ...
        //child: Stack(children: [icons(), addActivityScreenUI()]),
        child: addActivityScreenUI(),
      ),
    );
  }

  Widget addActivityScreenUI() {
    return SafeArea(
          ...
          onTap: () {
            if (formKey.currentState!.validate()) {
              ...
              _activity = ActivityData(
                  ...
                  quantity: quantity,
                  state: widget.activityData.state);

              DBService.instance
                  .editActivity(
                      widget.activityData.activityId, _activity!.toMapUpdate())
                  .then((_) => NavigationService.instance
                      .navigateToReplacementName(ActivitysScreen.routeName));
            }
          },
        ),
      ],
